...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    Pop_concern_support.set_Tk_var()
    top = Mise_à_jour_population_concernée (root)
    Pop_concern_support.init(root, top)
    root.mainloop()

w = None
def create_Mise_à_jour_population_concernée(root, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = Toplevel (root)
    Pop_concern_support.set_Tk_var()
    top = Mise_à_jour_population_concernée (w)
    Pop_concern_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_Mise_à_jour_population_concernée():
    global w
    w.destroy()
    w = None


class Mise_à_jour_population_concernée:
    def maj():
        Pop_concern_support.heure.set(time.strftime('%H:%M:%S'))
        root.after(1000,Mise_à_jour_population_concernée.maj)
    def __init__(self, top=None):
        ...
        top.title("Mise à jour population concernée")
        ...
        self.Labelframe1.configure(text='''Info/Population''')
        ...
        self.Button1.bind('<Button-1>',lambda e:Pop_concern_support.Valider(e))
        ...
        self.Labelframe4.configure(text='''Liste des populations concernées''')
        ...
        self.Label8.configure(textvariable=Pop_concern_support.heure)
        Mise_à_jour_population_concernée.maj()
