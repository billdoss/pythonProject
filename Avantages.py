...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    Avantages_support.set_Tk_var()
    top = Mise_à_jour_avantages (root)
    Avantages_support.init(root, top)
    root.mainloop()

w = None
def create_Mise_à_jour_avantages(root, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = Toplevel (root)
    Avantages_support.set_Tk_var()
    top = Mise_à_jour_avantages (w)
    Avantages_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_Mise_à_jour_avantages():
    global w
    w.destroy()
    w = None


class Mise_à_jour_avantages:
    def maj():
        Avantages_support.heure.set(time.strftime('%H:%M:%S'))
        root.after(1000,Mise_à_jour_avantages.maj)
    def __init__(self, top=None):
        def inserer():

            self.listead.insert('', 1, values=(Avantages_support.lib.get(),Avantages_support.grade.get(),Avantages_support.niveau.get()))
        ...
        top.title("Mise à jour avantages")
        ...
        self.Labelframe1.configure(text='''Info/Avantages''')
        ...
        self.Entry1.configure(textvariable=Avantages_support.code)
        ...
        self.Entry2.configure(textvariable=Avantages_support.lib)

        self.Label3 = Label(self.Labelframe1)
        self.Label3.place(relx=0.05, rely=0.65, height=26, width=41)
        ...
        self.Label3.configure(text='''Grade''')

        self.Entry3 = Entry(self.Labelframe1)
        self.Entry3.place(relx=0.17, rely=0.65, relheight=0.07, relwidth=0.16)
        ...
        self.Entry3.configure(textvariable=Avantages_support.grade)

        self.Label4 = Label(self.Labelframe1)
        self.Label4.place(relx=0.65, rely=0.65, height=26, width=61)
        ...
        self.Label4.configure(text='''Niveau''')

        self.Entry4 = Entry(self.Labelframe1)
        self.Entry4.place(relx=0.76, rely=0.65, relheight=0.07, relwidth=0.16)
        ...
        self.Entry4.configure(textvariable=Avantages_support.niveau)
        ...
        self.Button1.bind('<Button-1>',lambda e:Avantages_support.Valider(e))
        ...
        self.Labelframe4.configure(text='''Liste des avantages''')
        ...
        self.listead= ttk.Treeview(self.Labelframe4,columns=('Libellé','Grade','Niveau'))
        ...
        self.listead.heading('#2',text='Grade',anchor=CENTER)
        self.listead.heading('#3',text='Niveau',anchor=CENTER)
        ...
        self.Label8.configure(textvariable=Avantages_support.heure)
        Mise_à_jour_avantages.maj()
