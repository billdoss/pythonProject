...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    PI_support.set_Tk_var()
    top = Mise_à_jour_pièce_identité (root)
    PI_support.init(root, top)
    root.mainloop()

w = None
def create_Mise_à_jour_pièce_identité(root, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = Toplevel (root)
    PI_support.set_Tk_var()
    top = Mise_à_jour_pièce_identité (w)
    PI_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_Mise_à_jour_pièce_identité():
    global w
    w.destroy()
    w = None


class Mise_à_jour_pièce_identité:
    def maj():
        PI_support.heure.set(time.strftime('%H:%M:%S'))
        root.after(1000,Mise_à_jour_pièce_identité.maj)
    def __init__(self, top=None):
        ...
        top.title("Mise à jour pièce identité")
        ...
        self.Labelframe1.configure(text='''Info/Pièce''')
        ...
        self.Button1.bind('<Button-1>',lambda e:PI_support.Valider(e))
        ...
        self.Labelframe4.configure(text='''Liste des pièces d'identité''')
        ...
        self.Label8.configure(textvariable=PI_support.heure)
        Mise_à_jour_pièce_identité.maj()
