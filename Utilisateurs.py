...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    Utilisateurs_support.set_Tk_var()
    top = Mise_à_jour_des_utilisateurs (root)
    Utilisateurs_support.init(root, top)
    root.mainloop()

w = None
def create_Mise_à_jour_des_utilisateurs(root, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = Toplevel (root)
    Utilisateurs_support.set_Tk_var()
    top = Mise_à_jour_des_utilisateurs (w)
    Utilisateurs_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_Mise_à_jour_des_utilisateurs():
    global w
    w.destroy()
    w = None


class Mise_à_jour_des_utilisateurs:
    def maj():
        Utilisateurs_support.heure.set(time.strftime('%H:%M:%S'))
        root.after(1000,Mise_à_jour_des_utilisateurs.maj)
    def __init__(self, top=None):
        ...
        top.title("Mise à jour des utilisateurs")
        ...
        self.Labelframe1.configure(text='''Info/Utilisateurs''')
        ...
        self.Label1.place(relx=0.05, rely=0.42, height=26, width=39)
        ...
        self.Label2.place(relx=0.65, rely=0.43, height=26, width=90)
        ...
        self.Label3.place(relx=0.05, rely=0.65, height=26, width=65)
        ...
        self.Label3.configure(text='''Matricule''')
        ...
        self.Label4.place(relx=0.63, rely=0.65, height=26, width=110)
        ...
        self.Label4.configure(text='''Date de création''')
        ...
        self.Button1.bind('<Button-1>',lambda e:Utilisateurs_support.Valider(e))
        ...
        self.Labelframe4.configure(text='''Liste des utilisateurs''')
        ...
        self.listead= ttk.Treeview(self.Labelframe4,columns=('Nom','Date de création'))
        ...
        self.listead.heading('#2',text='date de création',anchor=CENTER)
        ...
        self.Label8.configure(textvariable=Utilisateurs_support.heure)
        Mise_à_jour_des_utilisateurs.maj()
