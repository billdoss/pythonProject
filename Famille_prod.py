...
def vp_start_gui():
    ...
    global val, w, root
    root = Tk()
    Famille_prod_support.set_Tk_var()
    top = Mise_à_jour_famille_produit (root)
    Famille_prod_support.init(root, top)
    root.mainloop()

w = None
def create_Mise_à_jour_famille_produit(root, *args, **kwargs):
    '''Starting point when module is imported by another program.'''
    global w, w_win, rt
    rt = root
    w = Toplevel (root)
    Famille_prod_support.set_Tk_var()
    top = Mise_à_jour_famille_produit (w)
    Famille_prod_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_Mise_à_jour_famille_produit():
    global w
    w.destroy()
    w = None


class Mise_à_jour_famille_produit:
    def maj():
        Famille_prod_support.heure.set(time.strftime('%H:%M:%S'))
        root.after(1000,Mise_à_jour_famille_produit.maj)
    def __init__(self, top=None):

        def inserer():

            self.listead.insert('', 1, values=(Famille_prod_support.code.get(),Famille_prod_support.lib.get()))
        ...
        top.title("Mise à jour famille produit")
        ...
        self.Labelframe1.configure(text='''Info/Famille produit''')
        ...
        self.Entry1.configure(textvariable=Famille_prod_support.code)
        ...
        self.Entry2.configure(textvariable=Famille_prod_support.lib)
        ...
        self.Button1.bind('<Button-1>',lambda e:Famille_prod_support.Valider(e))
        ...
        self.Labelframe4.configure(text='''Liste des familles de produit''')
        ...
        self.listead= ttk.Treeview(self.Labelframe4,columns=('Code','Libéllé'))
        ...
        self.Label8.configure(textvariable=Famille_prod_support.heure)
        Mise_à_jour_famille_produit.maj()
